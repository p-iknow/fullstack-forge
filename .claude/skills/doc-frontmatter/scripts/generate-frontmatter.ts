...
function determineType(content: string, filename: string): DocumentType {
  ...
  if (lowerContent.includes('## status') && lowerContent.includes('## context')) return 'adr'
  if (lowerContent.includes('## problem') && lowerContent.includes('## solution'))
    return 'troubleshooting'
  if (lowerContent.includes('pattern')) return 'pattern'
  if (
    lowerContent.includes('step') &&
    (lowerContent.includes('1.') || lowerContent.includes('step'))
  )
    return 'tutorial'
  if (lowerContent.includes('how to') || lowerContent.includes('guide')) return 'guide'
  if (
    ...
    return 'reference'
  if (lowerContent.includes('why') || lowerContent.includes('background')) return 'explanation'
