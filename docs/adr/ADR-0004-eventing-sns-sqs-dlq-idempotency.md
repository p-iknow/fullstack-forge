...
- Satisfies:
  - `docs/prd/04-event-reliability-and-ops-policy.md` (fanout/idempotency/DLQ/redrive)
- Supports:
  - `docs/prd/01-product-scope.md` (신뢰성 KPI)
  - `docs/prd/05-phased-delivery-plan.md` (Stage 4~5 검증)
...
- 내부 근거: `docs/harness/00-overview.md`, `docs/prd/04-event-reliability-and-ops-policy.md`
