...
옵션 2를 채택한다. `docs/adr/`에 번호 기반 ADR을 생성하고,
`docs/prd/06-architecture-requirements-document.md`는 ADR 인덱스/추적 요약으로 사용한다.
...
- 구현 절차는 ADR이 아니라 `docs/prd/05-phased-delivery-plan.md`에서 관리한다.
