...
**Result** — `docs/01-prd/01-auth/01-overview.md`의 계정 상태/권한 요구와 비밀번호 보안 요구를 책임별로 분리해 운영할 수 있다.
...
**Result** — `docs/01-prd/01-auth/01-overview.md`의 refresh rotation, reuse detection, 만료 정책을 서버 저장소 기준으로 구현할 수 있다.
