...
- **패턴 레퍼런스**:
  - API client: `apps/store/src/@shared/api/catalog.ts`
  - Query options: `apps/store/src/@shared/queries/catalog.ts`
  - Route file: `apps/store/src/routes/_catalog/index.tsx`
  - Screen: `apps/store/src/pages/home/home-page.tsx`
...
- `apps/store/src/pages/cart/cart-page.tsx`
- `apps/store/src/pages/cart/cart-item-row.tsx`
- `apps/store/src/pages/cart/cart-summary.tsx`
...
파일: `apps/store/src/@shared/api/cart.ts`
...
파일: `apps/store/src/@shared/queries/cart.ts`
...
파일: `apps/store/src/pages/cart/cart-page.tsx`

### 5. CartItemRow component

파일: `apps/store/src/pages/cart/cart-item-row.tsx`
...
파일: `apps/store/src/pages/cart/cart-summary.tsx`
...
파일: `apps/store/src/pages/cart/empty-cart.tsx` — "장바구니가 비어있습니다" + 쇼핑하기 링크
