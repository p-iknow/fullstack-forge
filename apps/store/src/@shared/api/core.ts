 ...
 * in-flight request to avoid refresh-token reuse detection on the server.
 */
 ...
 * access token via the `/api/auth/refresh` endpoint.
 *
 * Use this for hand-written fetch calls (e.g. catalog API). The generated
 * openapi-ts client uses a response interceptor instead — see generated-client.ts.
 */
